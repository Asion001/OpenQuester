...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _232: (x0,x1,x2) => x0.postMessage(x1,x2),
      _259: () => globalThis.self,
      _260: () => new MessageChannel(),
      _261: x0 => x0.close(),
      _262: x0 => x0.close(),
      _263: x0 => x0.close(),
      ...
      _266: (x0,x1,x2) => x0.postMessage(x1,x2),
      _267: (x0,x1) => x0.postMessage(x1),
      _272: (x0,x1) => x0.push(x1),
      _273: (x0,x1) => x0.push(x1),
      _279: (x0,x1) => x0.push(x1),
      _280: () => new Map(),
      _281: (x0,x1,x2) => x0.set(x1,x2),
      _282: () => new Set(),
      _283: (x0,x1) => x0.add(x1),
      _284: x0 => globalThis.BigInt(x0),
      _285: (x0,x1) => x0.at(x1),
      _286: x0 => x0.entries(),
      _287: (x0,x1) => x0.at(x1),
      _288: (x0,x1) => x0.at(x1),
      ...
      _322: (x0,x1) => x0.exec(x1),
      _324: (x0,x1) => x0.exec(x1),
      _328: o => o === undefined,
      _347: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _349: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _350: o => o instanceof RegExp,
      _351: (l, r) => l === r,
      _352: o => o,
      _353: o => o,
      _354: o => o,
      ...
      _356: o => o.length,
      _359: (o, i) => o[i],
      _360: f => f.dartFunction,
      _361: l => arrayFromDartList(Int8Array, l),
      _362: l => arrayFromDartList(Uint8Array, l),
      _363: l => arrayFromDartList(Uint8ClampedArray, l),
      _364: l => arrayFromDartList(Int16Array, l),
      _365: l => arrayFromDartList(Uint16Array, l),
      _366: l => arrayFromDartList(Int32Array, l),
      _367: l => arrayFromDartList(Uint32Array, l),
      _368: l => arrayFromDartList(Float32Array, l),
      _369: l => arrayFromDartList(Float64Array, l),
      _370: x0 => new ArrayBuffer(x0),
      _371: (data, length) => {
      ...
      _372: l => arrayFromDartList(Array, l),
      _373: () => ({}),
      _374: () => [],
      _375: l => new Array(l),
      _376: () => globalThis,
      ...
      _387: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmI8ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _390: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _406: x0 => x0.ignoreCase,
      _407: x0 => x0.unicode,
      _408: x0 => x0.dotAll,
      _409: (x0,x1) => x0.lastIndex = x1,
      _411: (o, p) => o[p],
      _414: x0 => x0.random(),
      _415: x0 => x0.random(),
