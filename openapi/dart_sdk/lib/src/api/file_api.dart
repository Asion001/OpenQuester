...
class FileApi {
  ...
  ///
  /// Parameters:
  /// * [v1FileGetRequest] - Filename which you want to delete
  ...
  Future<Response<V1FileDelete204Response>> v1FileDelete({
    required V1FileGetRequest v1FileGetRequest,
    ...
    try {
      const _type = FullType(V1FileGetRequest);
      _bodyData =
          _serializers.serialize(v1FileGetRequest, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [v1FileGetRequest] - Filename which you want to get
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [v1FileGetRequest] - Filename which you want to put in bucket
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
