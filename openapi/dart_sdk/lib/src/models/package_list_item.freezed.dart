...
mixin _$PackageListItem {
  ...
  $PackageListItemCopyWith<PackageListItem> get copyWith =>
      _$PackageListItemCopyWithImpl<PackageListItem>(
          this as PackageListItem, _$identity);
...
abstract mixin class $PackageListItemCopyWith<$Res> {
  factory $PackageListItemCopyWith(
          PackageListItem value, $Res Function(PackageListItem) _then) =
      _$PackageListItemCopyWithImpl;
  @useResult
  $Res call(
      {int id,
      String title,
...
class _PackageListItem implements PackageListItem {
  const _PackageListItem(
      ...
      this.logo})
      : _tags = tags;
  factory _PackageListItem.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PackageListItemCopyWith<_PackageListItem> get copyWith =>
      __$PackageListItemCopyWithImpl<_PackageListItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PackageListItemToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PackageListItemCopyWith<$Res>
    implements $PackageListItemCopyWith<$Res> {
  factory _$PackageListItemCopyWith(
          _PackageListItem value, $Res Function(_PackageListItem) _then) =
      __$PackageListItemCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id,
