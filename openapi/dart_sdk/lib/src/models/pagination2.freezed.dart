...
abstract class $Pagination2CopyWith<$Res> {
  ...
  @useResult
  $Res call({SortBy2 sortBy, Order order, int limit, int offset});
}
...
class _$Pagination2Impl implements _Pagination2 {
  ...
  @override
  String toString() {
    return 'Pagination2(sortBy: $sortBy, order: $order, limit: $limit, offset: $offset)';
  }
...
abstract class _Pagination2 implements Pagination2 {
  const factory _Pagination2(
      {required final SortBy2 sortBy,
      required final Order order,
      required final int limit,
      required final int offset}) = _$Pagination2Impl;
