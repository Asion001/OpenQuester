...
class _$SimpleQuestionImpl implements _SimpleQuestion {
  ...
  @override
  String toString() {
    return 'SimpleQuestion(id: $id, price: $price, text: $text, answerHint: $answerHint, answerText: $answerText, questionComment: $questionComment, questionFiles: $questionFiles, answerFiles: $answerFiles, type: $type, isHidden: $isHidden, answerDelay: $answerDelay)';
  }
