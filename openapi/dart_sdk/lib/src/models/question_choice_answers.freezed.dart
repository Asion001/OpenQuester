...
mixin _$QuestionChoiceAnswers {
  ...
  $QuestionChoiceAnswersCopyWith<QuestionChoiceAnswers> get copyWith =>
      _$QuestionChoiceAnswersCopyWithImpl<QuestionChoiceAnswers>(
          this as QuestionChoiceAnswers, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is QuestionChoiceAnswers &&
...
abstract mixin class $QuestionChoiceAnswersCopyWith<$Res> {
  factory $QuestionChoiceAnswersCopyWith(QuestionChoiceAnswers value,
          $Res Function(QuestionChoiceAnswers) _then) =
      _$QuestionChoiceAnswersCopyWithImpl;
  @useResult
  $Res call(
...
class _QuestionChoiceAnswers implements QuestionChoiceAnswers {
  const _QuestionChoiceAnswers(
      {required this.id, required this.order, required this.text, this.file});
  factory _QuestionChoiceAnswers.fromJson(Map<String, dynamic> json) =>
      _$QuestionChoiceAnswersFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$QuestionChoiceAnswersCopyWith<_QuestionChoiceAnswers> get copyWith =>
      __$QuestionChoiceAnswersCopyWithImpl<_QuestionChoiceAnswers>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$QuestionChoiceAnswersToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _QuestionChoiceAnswers &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.order, order) || other.order == order) &&
            (identical(other.text, text) || other.text == text) &&
            (identical(other.file, file) || other.file == file));
...
/// @nodoc
abstract mixin class _$QuestionChoiceAnswersCopyWith<$Res>
    implements $QuestionChoiceAnswersCopyWith<$Res> {
  factory _$QuestionChoiceAnswersCopyWith(_QuestionChoiceAnswers value,
          $Res Function(_QuestionChoiceAnswers) _then) =
      __$QuestionChoiceAnswersCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? id, PackageEntitiesOrder order, String? text, FileItem? file});
