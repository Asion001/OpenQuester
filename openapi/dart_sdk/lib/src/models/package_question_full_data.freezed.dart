...
part of 'package_question_full_data.dart';
...
/// @nodoc
mixin _$PackageQuestionFullData {
 ...
 String? get questionComment; QuestionSubType get subType; QuestionAnswerText? get answerText; List<PackageQuestionFile?>? get questionFiles; List<PackageAnswerFile?>? get answerFiles; QuestionMaxPrice? get maxPrice; QuestionAllowedPrices? get allowedPrices; QuestionTransferType? get transferType; QuestionPriceMultiplier? get priceMultiplier; QuestionShowDelay? get showDelay; List<QuestionChoiceAnswers?>? get answers;/// Whether the question is hidden
 bool get isHidden;/// Delay in milliseconds before being able to answer, if applicable
 int get answerDelay;
/// Create a copy of PackageQuestionFullData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PackageQuestionFullDataCopyWith<PackageQuestionFullData> get copyWith => _$PackageQuestionFullDataCopyWithImpl<PackageQuestionFullData>(this as PackageQuestionFullData, _$identity);

  /// Serializes this PackageQuestionFullData to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PackageQuestionFullData&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.order, order) || other.order == order)&&(identical(other.price, price) || other.price == price)&&(identical(other.text, text) || other.text == text)&&(identical(other.answerHint, answerHint) || other.answerHint == answerHint)&&(identical(other.questionComment, questionComment) || other.questionComment == questionComment)&&(identical(other.subType, subType) || other.subType == subType)&&(identical(other.answerText, answerText) || other.answerText == answerText)&&const DeepCollectionEquality().equals(other.questionFiles, questionFiles)&&const DeepCollectionEquality().equals(other.answerFiles, answerFiles)&&(identical(other.maxPrice, maxPrice) || other.maxPrice == maxPrice)&&const DeepCollectionEquality().equals(other.allowedPrices, allowedPrices)&&(identical(other.transferType, transferType) || other.transferType == transferType)&&(identical(other.priceMultiplier, priceMultiplier) || other.priceMultiplier == priceMultiplier)&&(identical(other.showDelay, showDelay) || other.showDelay == showDelay)&&const DeepCollectionEquality().equals(other.answers, answers)&&(identical(other.isHidden, isHidden) || other.isHidden == isHidden)&&(identical(other.answerDelay, answerDelay) || other.answerDelay == answerDelay));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,type,order,price,text,answerHint,questionComment,subType,answerText,const DeepCollectionEquality().hash(questionFiles),const DeepCollectionEquality().hash(answerFiles),maxPrice,const DeepCollectionEquality().hash(allowedPrices),transferType,priceMultiplier,showDelay,const DeepCollectionEquality().hash(answers),isHidden,answerDelay]);

@override
String toString() {
  return 'PackageQuestionFullData(id: $id, type: $type, order: $order, price: $price, text: $text, answerHint: $answerHint, questionComment: $questionComment, subType: $subType, answerText: $answerText, questionFiles: $questionFiles, answerFiles: $answerFiles, maxPrice: $maxPrice, allowedPrices: $allowedPrices, transferType: $transferType, priceMultiplier: $priceMultiplier, showDelay: $showDelay, answers: $answers, isHidden: $isHidden, answerDelay: $answerDelay)';
}
...
/// @nodoc
abstract mixin class $PackageQuestionFullDataCopyWith<$Res>  {
  factory $PackageQuestionFullDataCopyWith(PackageQuestionFullData value, $Res Function(PackageQuestionFullData) _then) = _$PackageQuestionFullDataCopyWithImpl;
@useResult
$Res call({
 int? id, QuestionType type, PackageEntitiesOrder order, int? price, String? text, String? answerHint, String? questionComment, QuestionSubType subType, QuestionAnswerText? answerText, List<PackageQuestionFile?>? questionFiles, List<PackageAnswerFile?>? answerFiles, QuestionMaxPrice? maxPrice, QuestionAllowedPrices? allowedPrices, QuestionTransferType? transferType, QuestionPriceMultiplier? priceMultiplier, QuestionShowDelay? showDelay, List<QuestionChoiceAnswers?>? answers, bool isHidden, int answerDelay
});
...
/// @nodoc
class _$PackageQuestionFullDataCopyWithImpl<$Res>
    implements $PackageQuestionFullDataCopyWith<$Res> {
  _$PackageQuestionFullDataCopyWithImpl(this._self, this._then);

  final PackageQuestionFullData _self;
  final $Res Function(PackageQuestionFullData) _then;

/// Create a copy of PackageQuestionFullData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? type = null,Object? order = null,Object? price = freezed,Object? text = freezed,Object? answerHint = freezed,Object? questionComment = freezed,Object? subType = null,Object? answerText = freezed,Object? questionFiles = freezed,Object? answerFiles = freezed,Object? maxPrice = freezed,Object? allowedPrices = freezed,Object? transferType = freezed,Object? priceMultiplier = freezed,Object? showDelay = freezed,Object? answers = freezed,Object? isHidden = null,Object? answerDelay = null,}) {
...
as QuestionSubType,answerText: freezed == answerText ? _self.answerText : answerText // ignore: cast_nullable_to_non_nullable
...
as List<PackageAnswerFile?>?,maxPrice: freezed == maxPrice ? _self.maxPrice : maxPrice // ignore: cast_nullable_to_non_nullable
...
class _PackageQuestionFullData implements PackageQuestionFullData {
  const _PackageQuestionFullData({required this.id, required this.type, required this.order, required this.price, required this.text, required this.answerHint, required this.questionComment, required this.subType, this.answerText, final  List<PackageQuestionFile?>? questionFiles, final  List<PackageAnswerFile?>? answerFiles, this.maxPrice, final  QuestionAllowedPrices? allowedPrices, this.transferType, this.priceMultiplier, this.showDelay, final  List<QuestionChoiceAnswers?>? answers, this.isHidden = false, this.answerDelay = 4000}): _questionFiles = questionFiles,_answerFiles = answerFiles,_allowedPrices = allowedPrices,_answers = answers;
  factory _PackageQuestionFullData.fromJson(Map<String, dynamic> json) => _$PackageQuestionFullDataFromJson(json);
...
@override List<PackageAnswerFile?>? get answerFiles {
...
@pragma('vm:prefer-inline')
_$PackageQuestionFullDataCopyWith<_PackageQuestionFullData> get copyWith => __$PackageQuestionFullDataCopyWithImpl<_PackageQuestionFullData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PackageQuestionFullDataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PackageQuestionFullData&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.order, order) || other.order == order)&&(identical(other.price, price) || other.price == price)&&(identical(other.text, text) || other.text == text)&&(identical(other.answerHint, answerHint) || other.answerHint == answerHint)&&(identical(other.questionComment, questionComment) || other.questionComment == questionComment)&&(identical(other.subType, subType) || other.subType == subType)&&(identical(other.answerText, answerText) || other.answerText == answerText)&&const DeepCollectionEquality().equals(other._questionFiles, _questionFiles)&&const DeepCollectionEquality().equals(other._answerFiles, _answerFiles)&&(identical(other.maxPrice, maxPrice) || other.maxPrice == maxPrice)&&const DeepCollectionEquality().equals(other._allowedPrices, _allowedPrices)&&(identical(other.transferType, transferType) || other.transferType == transferType)&&(identical(other.priceMultiplier, priceMultiplier) || other.priceMultiplier == priceMultiplier)&&(identical(other.showDelay, showDelay) || other.showDelay == showDelay)&&const DeepCollectionEquality().equals(other._answers, _answers)&&(identical(other.isHidden, isHidden) || other.isHidden == isHidden)&&(identical(other.answerDelay, answerDelay) || other.answerDelay == answerDelay));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,type,order,price,text,answerHint,questionComment,subType,answerText,const DeepCollectionEquality().hash(_questionFiles),const DeepCollectionEquality().hash(_answerFiles),maxPrice,const DeepCollectionEquality().hash(_allowedPrices),transferType,priceMultiplier,showDelay,const DeepCollectionEquality().hash(_answers),isHidden,answerDelay]);
...
/// @nodoc
abstract mixin class _$PackageQuestionFullDataCopyWith<$Res> implements $PackageQuestionFullDataCopyWith<$Res> {
  factory _$PackageQuestionFullDataCopyWith(_PackageQuestionFullData value, $Res Function(_PackageQuestionFullData) _then) = __$PackageQuestionFullDataCopyWithImpl;
@override @useResult
$Res call({
 int? id, QuestionType type, PackageEntitiesOrder order, int? price, String? text, String? answerHint, String? questionComment, QuestionSubType subType, QuestionAnswerText? answerText, List<PackageQuestionFile?>? questionFiles, List<PackageAnswerFile?>? answerFiles, QuestionMaxPrice? maxPrice, QuestionAllowedPrices? allowedPrices, QuestionTransferType? transferType, QuestionPriceMultiplier? priceMultiplier, QuestionShowDelay? showDelay, List<QuestionChoiceAnswers?>? answers, bool isHidden, int answerDelay
});
...
/// @nodoc
class __$PackageQuestionFullDataCopyWithImpl<$Res>
    implements _$PackageQuestionFullDataCopyWith<$Res> {
  __$PackageQuestionFullDataCopyWithImpl(this._self, this._then);

  final _PackageQuestionFullData _self;
  final $Res Function(_PackageQuestionFullData) _then;

/// Create a copy of PackageQuestionFullData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? type = null,Object? order = null,Object? price = freezed,Object? text = freezed,Object? answerHint = freezed,Object? questionComment = freezed,Object? subType = null,Object? answerText = freezed,Object? questionFiles = freezed,Object? answerFiles = freezed,Object? maxPrice = freezed,Object? allowedPrices = freezed,Object? transferType = freezed,Object? priceMultiplier = freezed,Object? showDelay = freezed,Object? answers = freezed,Object? isHidden = null,Object? answerDelay = null,}) {
  return _then(_PackageQuestionFullData(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as QuestionType,order: null == order ? _self.order : order // ignore: cast_nullable_to_non_nullable
as PackageEntitiesOrder,price: freezed == price ? _self.price : price // ignore: cast_nullable_to_non_nullable
