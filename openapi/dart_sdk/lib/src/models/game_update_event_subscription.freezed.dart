...
mixin _$GameUpdateEventSubscription {
  ...
  $GameUpdateEventSubscriptionCopyWith<GameUpdateEventSubscription>
      get copyWith => _$GameUpdateEventSubscriptionCopyWithImpl<
              GameUpdateEventSubscription>(
          this as GameUpdateEventSubscription, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GameUpdateEventSubscription &&
...
abstract mixin class $GameUpdateEventSubscriptionCopyWith<$Res> {
  factory $GameUpdateEventSubscriptionCopyWith(
          ...
          $Res Function(GameUpdateEventSubscription) _then) =
      _$GameUpdateEventSubscriptionCopyWithImpl;
  @useResult
...
class _GameUpdateEventSubscription implements GameUpdateEventSubscription {
  ...
  factory _GameUpdateEventSubscription.fromJson(Map<String, dynamic> json) =>
      _$GameUpdateEventSubscriptionFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GameUpdateEventSubscriptionCopyWith<_GameUpdateEventSubscription>
      get copyWith => __$GameUpdateEventSubscriptionCopyWithImpl<
          _GameUpdateEventSubscription>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$GameUpdateEventSubscriptionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GameUpdateEventSubscription &&
            (identical(other.event, event) || other.event == event) &&
            (identical(other.data, data) || other.data == data));
  }
...
/// @nodoc
abstract mixin class _$GameUpdateEventSubscriptionCopyWith<$Res>
    implements $GameUpdateEventSubscriptionCopyWith<$Res> {
  factory _$GameUpdateEventSubscriptionCopyWith(
          _GameUpdateEventSubscription value,
          $Res Function(_GameUpdateEventSubscription) _then) =
      __$GameUpdateEventSubscriptionCopyWithImpl;
  @override
  @useResult
  $Res call({GameUpdateEventSubscriptionEvent event, GameListItem data});
