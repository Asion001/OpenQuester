...
mixin _$FileInput {
  ...
  $FileInputCopyWith<FileInput> get copyWith =>
      _$FileInputCopyWithImpl<FileInput>(this as FileInput, _$identity);
...
abstract mixin class $FileInputCopyWith<$Res> {
  factory $FileInputCopyWith(FileInput value, $Res Function(FileInput) _then) =
      _$FileInputCopyWithImpl;
  @useResult
  $Res call({String md5, PackageFileType type});
}

/// @nodoc
class _$FileInputCopyWithImpl<$Res> implements $FileInputCopyWith<$Res> {
...
class _FileInput implements FileInput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$FileInputCopyWith<_FileInput> get copyWith =>
      __$FileInputCopyWithImpl<_FileInput>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$FileInputToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$FileInputCopyWith<$Res>
    implements $FileInputCopyWith<$Res> {
  factory _$FileInputCopyWith(
          _FileInput value, $Res Function(_FileInput) _then) =
      __$FileInputCopyWithImpl;
  @override
  @useResult
  $Res call({String md5, PackageFileType type});
}
...
/// @nodoc
class __$FileInputCopyWithImpl<$Res> implements _$FileInputCopyWith<$Res> {
