...
mixin _$SocketIOGameUnpauseEventPayload {
  ...
  $SocketIOGameUnpauseEventPayloadCopyWith<SocketIOGameUnpauseEventPayload>
      get copyWith => _$SocketIOGameUnpauseEventPayloadCopyWithImpl<
              SocketIOGameUnpauseEventPayload>(
          this as SocketIOGameUnpauseEventPayload, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SocketIOGameUnpauseEventPayload &&
...
abstract mixin class $SocketIOGameUnpauseEventPayloadCopyWith<$Res> {
  factory $SocketIOGameUnpauseEventPayloadCopyWith(
          SocketIOGameUnpauseEventPayload value,
          $Res Function(SocketIOGameUnpauseEventPayload) _then) =
      _$SocketIOGameUnpauseEventPayloadCopyWithImpl;
  @useResult
...
/// @nodoc
@JsonSerializable()
class _SocketIOGameUnpauseEventPayload
    implements SocketIOGameUnpauseEventPayload {
  const _SocketIOGameUnpauseEventPayload({required this.timer});
  factory _SocketIOGameUnpauseEventPayload.fromJson(
          Map<String, dynamic> json) =>
      _$SocketIOGameUnpauseEventPayloadFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SocketIOGameUnpauseEventPayloadCopyWith<_SocketIOGameUnpauseEventPayload>
      get copyWith => __$SocketIOGameUnpauseEventPayloadCopyWithImpl<
          _SocketIOGameUnpauseEventPayload>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SocketIOGameUnpauseEventPayloadToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SocketIOGameUnpauseEventPayload &&
            (identical(other.timer, timer) || other.timer == timer));
  }
...
/// @nodoc
abstract mixin class _$SocketIOGameUnpauseEventPayloadCopyWith<$Res>
    implements $SocketIOGameUnpauseEventPayloadCopyWith<$Res> {
  factory _$SocketIOGameUnpauseEventPayloadCopyWith(
          _SocketIOGameUnpauseEventPayload value,
          $Res Function(_SocketIOGameUnpauseEventPayload) _then) =
      __$SocketIOGameUnpauseEventPayloadCopyWithImpl;
  @override
  @useResult
  $Res call({GameStateTimer timer});
