...
mixin _$SocketIOAnswerResultInput {
  ...
  $SocketIOAnswerResultInputCopyWith<SocketIOAnswerResultInput> get copyWith =>
      _$SocketIOAnswerResultInputCopyWithImpl<SocketIOAnswerResultInput>(
          this as SocketIOAnswerResultInput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SocketIOAnswerResultInput &&
...
abstract mixin class $SocketIOAnswerResultInputCopyWith<$Res> {
  factory $SocketIOAnswerResultInputCopyWith(SocketIOAnswerResultInput value,
          $Res Function(SocketIOAnswerResultInput) _then) =
      _$SocketIOAnswerResultInputCopyWithImpl;
  @useResult
  $Res call({int scoreResult});
}
...
class _SocketIOAnswerResultInput implements SocketIOAnswerResultInput {
  ...
  factory _SocketIOAnswerResultInput.fromJson(Map<String, dynamic> json) =>
      _$SocketIOAnswerResultInputFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SocketIOAnswerResultInputCopyWith<_SocketIOAnswerResultInput>
      get copyWith =>
          __$SocketIOAnswerResultInputCopyWithImpl<_SocketIOAnswerResultInput>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SocketIOAnswerResultInputToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SocketIOAnswerResultInput &&
            (identical(other.scoreResult, scoreResult) ||
                other.scoreResult == scoreResult));
  }
...
/// @nodoc
abstract mixin class _$SocketIOAnswerResultInputCopyWith<$Res>
    implements $SocketIOAnswerResultInputCopyWith<$Res> {
  factory _$SocketIOAnswerResultInputCopyWith(_SocketIOAnswerResultInput value,
          $Res Function(_SocketIOAnswerResultInput) _then) =
      __$SocketIOAnswerResultInputCopyWithImpl;
  @override
  @useResult
  $Res call({int scoreResult});
}
