...
class _GamesClient implements GamesClient {
  _GamesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<PaginatedGames> getV1Games({
    ...
    final _options = _setStreamType<PaginatedGames>(
  ...
  Future<GameListItem> postV1Games({required GameCreateData body}) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<GameListItem>(
  ...
  @override
  Future<GameListItem> getV1GamesGameId({required String gameId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
